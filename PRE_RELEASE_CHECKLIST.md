...
- [x] Configure GitHub Actions
  - [x] CI pipeline (format, lint, type-check, build)
  - [x] Automated releases (macOS DMG + Homebrew cask update)
  - [x] Web deployment (Cloudflare Pages)
...
- [x] GPL-2.0 license adopted due to bundling openscad-wasm
